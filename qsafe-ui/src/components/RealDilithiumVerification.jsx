...
export default function RealDilithiumVerification({ signer, publicKey, signature, message }) {
  ...
  const verifyOnChain = async () => {
    ...
    try {
      ...
      const event = events.find(function(e) { return e && e.event === 'SignatureVerified'; });
  ...
  return (
    <div className="risc-zero-verification">
      <h3>Dilithium-5 Verification (RISC Zero zkVM)</h3>
